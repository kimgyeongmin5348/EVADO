...
{
    return CompileShaderFromFile(L"Shaders.hlsl", "VSParticle", "vs_5_1", &m_pd3dVertexShaderBlob);
}

D3D12_SHADER_BYTECODE CParticleShader::CreatePixelShader()
{
    return CompileShaderFromFile(L"Shaders.hlsl", "PSParticle", "ps_5_1", &m_pd3dPixelShaderBlob);
}
