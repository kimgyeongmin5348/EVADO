...
class CIlluminatedObjectsShader : public CIlluminatedShader
{
public:
...
{
public:
	CDepthRenderShader(CIlluminatedObjectsShader* pObjectsShader, LIGHT* pLights);
...
{
public:
	CShadowMapShader(CIlluminatedObjectsShader* pObjectsShader);
